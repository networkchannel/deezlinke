        ...
        <section className="mb-16 sm:mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5">
              <Reveal delay={0.2}>
                <div className="glass backdrop-blur-xl rounded-2xl p-6 h-full border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02]">
                  ...
                  <p className="text-xs text-t-muted mb-6">
